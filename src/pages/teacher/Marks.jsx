          ...
          <>
            ...
            {exams.length === 0 ? (
              ...
              <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
                {exams.map((exam, i) => (
                  <div key={exam.id} className={`flex items-center gap-4 px-5 py-4 ${i < exams.length - 1 ? 'border-b border-gray-100 dark:border-gray-700' : ''} hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors`}>
            ...
            {proformaData && (() => {
              ...
              return (
                <div className="max-w-[1100px] mx-auto bg-[#faf8f3] dark:bg-gray-800 border-2 border-[#d4c89a] dark:border-gray-600 rounded-sm shadow-lg overflow-hidden relative">
                  ...
                  <div className="flex justify-between px-8 text-xs text-[#3a3a5c] dark:text-gray-400">
